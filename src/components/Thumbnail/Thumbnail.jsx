...
const Thumbnail = ({ item }) => {
  ...
  return (
      <figure className="figure mx-2">
        <img src={item.poster_path ? `https://image.tmdb.org/t/p/w600_and_h900_bestv2/${item.poster_path}` : noImageAvailable} className="figure figure-img rounded" alt={item.name ? item.name : item.title} />
